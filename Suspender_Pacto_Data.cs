...
{
    public class Suspender_Pacto_Data : ISpecification<Pacto>
    {
        ...
        {
            if((int)entity.IdSituacaoPacto != (int)eSituacaoPacto.Suspenso && entity.DataPrevistaTermino > DateTime.Now)
            {
                return true;
            }
